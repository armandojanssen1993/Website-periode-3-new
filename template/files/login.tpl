...
<div class="col-sm-8 blog-main">
    ...
    <div class="blog-post">
        ...
        <p><a href="index.php?pageid=8&action=2&option=1">Gebruikersnaam vergeten?</a> -
            <a href="index.php?pageid=8&action=2&option=2">Wachtwoord vergeten?</a> -
            <a href="index.php?pageid=8&action=2&option=3">Gebruikersnaam & wachtwoord vergeten</a></p>
